### A small script to convert CSV files exported by Studyblue into clean Rda files.
...
###
### For the legal people out there, this script is not linked in any way to Studyblue. It just happens that I wrote it to handle files exported from this platform.
...
x<-as.numeric(x)
if(x>length(dir()) || x<1) stop(errmsg1)
